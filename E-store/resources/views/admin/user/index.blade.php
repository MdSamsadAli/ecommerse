                                    ...
                                    <div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
                                        ...
                                        <div class="product_content">
                                            @if(!empty($user->product_price))
                                                <div class="product_price">{{$user->product_price}}</div>
                                            @endif

                                            @if(!empty($user->product_name))
                                                <div class="product_name"><div><a href="product.html">{{$user->product_name}}</a></div></div>
                                            @endif
                                        ...
                                        <ul class="product_marks">
                                            ...
                                            @if(!empty($user->product_mark))
                                                <li class="product_mark product_new">{{$user->product_mark}}</li>
                                            @endif
                                        </ul>
                                    </div>
                                </div>
