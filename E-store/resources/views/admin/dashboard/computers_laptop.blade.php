...
@section('content')
    ...
    <div class="home">
    <div class="home_background parallax-window" data-parallax="scroll" data-image-src="{{asset('resources/admin/images/shop_background.jpg')}}"></div>
    <div class="home_overlay"></div>
    <div class="home_content d-flex flex-column align-items-center justify-content-center">
        <h2 class="home_title">Computer & Laptops</h2>
    </div>
    </div>
                ...
                <div class="shop_content">
                    ...
                    <div class="product_grid">
                        ...
                        <div class="product_item discount">
                            ...
                            <div class="product_content">
                                <div class="product_price">Rs.225<span>Rs.300</span></div>
                    ...
                    <div class="owl-carousel owl-theme viewed_slider">
                        ...
                        <div class="owl-item">
                            <div class="viewed_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                ...
                                <div class="viewed_content text-center">
                                    <div class="viewed_price">Rs.379</div>
                        ...
                        <div class="owl-item">
                            <div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                ...
                                <div class="viewed_content text-center">
                                    <div class="viewed_price">Rs.225<span>Rs.300</span></div>
